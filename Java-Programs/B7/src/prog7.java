...
class prog7
{
	...
	{
		BufferedReader csv = new BufferedReader(new FileReader(new File("/Users/vishalprabhachandar/Documents/Programming/DataminingLab/Java-Programs/B7/src/input.csv")));
